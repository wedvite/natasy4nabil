<template>
  <section id="tentative" class="hero is-medium has-text-centered" :class="'bgt-' + theme">
    <div class="hero-body">
      ...
      <template v-else>
        ...
        >
          <div class="column is-4 has-text-right">{{t.time}}</div>
          <div class="column has-text-left">{{t.details}}</div>
        </div>
      </template>
    </div>
  </section>
